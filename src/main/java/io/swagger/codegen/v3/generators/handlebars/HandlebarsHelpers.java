...
public class HandlebarsHelpers {
    ...
    public CharSequence javaSdkVersion3(final Object element, final Options options) throws IOException {
        if ("true".equals(options.param(0))) {
            return options.fn();
        }

        if (Objects.equal(element, "aggregate")) {
            return options.inverse();
        }
        if (Objects.equal(element, "meta")) {
            return options.inverse();
        }
        if (Objects.equal(element, "validate")) {
            return options.inverse();
        }
        if (Objects.equal(element, "scrollExpire")) {
            return options.inverse();
        }
        if (Objects.equal(element, "scrollId")) {
            return options.inverse();
        }
