...
public abstract class AbstractPhpCodegen extends AbstractCodegen {
    ...
    @Override
    final public String getTypeDeclaration(Schema propertySchema) {
    ...
    @Override
    final public String getTypeDeclaration(String name) {
    ...
    @Override
    final public String getSchemaType(Schema property) {
